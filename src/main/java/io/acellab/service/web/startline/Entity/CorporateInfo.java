...
public class CorporateInfo{
	...
	@Column(name = "corporate_size", length = 50)
	private String corporateSize;
	
	@OneToMany(mappedBy = "corporate")
	private List<CorporateTeamInfo> members;
	

	public void setCorporateName(String name) {this.corporateName = name;}
	public String getCorporateName() {return this.corporateName;}
	...
	public void setCorporateSize(String size) {this.corporateSize = size;}
	public String getCorporateSize() {return this.corporateSize;}
	
	public List<CorporateTeamInfo> getMembers() {return this.members;}
	public void setMembers(List<CorporateTeamInfo> members) {this.members = members;}
	...
	@OneToMany(mappedBy = "corporate")
	private List<CorporateProductInfo> products;
	...
	public List<CorporateProductInfo> getProducts() {return this.products;}
	public void setProducts(List<CorporateProductInfo> products) {this.products = products;}
	...
	@OneToMany(mappedBy = "corporate")
    private List<CorporateFundingInfo> fundings;
	...
	public List<CorporateFundingInfo> getFundings() {return this.fundings;}
	public void setFundings(List<CorporateFundingInfo> fundings) {this.fundings = fundings;}
	...
	@Lob
	@Column(name = "ai_answer_1")
	private String aiAnswer1;
	
	@Lob
	@Column(name = "ai_answer_2")
	private String aiAnswer2;
	
	@Lob
	@Column(name = "ai_answer_3")
	private String aiAnswer3;
	
	@Lob
	@Column(name = "ai_answer_4")
	private String aiAnswer4;
	
	@Lob
	@Column(name = "ai_answer_5")
	private String aiAnswer5;
	
	
	public void setAiAnswer1(String ans) {this.aiAnswer1 = ans;}
	public String getAiAnswer1() {return this.aiAnswer1;}
	
	public void setAiAnswer2(String ans) {this.aiAnswer2 = ans;}
	public String getAiAnswer2() {return this.aiAnswer2;}
	
	public void setAiAnswer3(String ans) {this.aiAnswer3 = ans;}
	public String getAiAnswer3() {return this.aiAnswer3;}
	
	public void setAiAnswer4(String ans) {this.aiAnswer4 = ans;}
	public String getAiAnswer4() {return this.aiAnswer4;}
	
	public void setAiAnswer5(String ans) {this.aiAnswer5 = ans;}
	public String getAiAnswer5() {return this.aiAnswer5;}
