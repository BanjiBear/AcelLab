...
public enum Status {
    ...
    //User Status
    USER_INVALID_OLD_PASSWORD(9, "USER_INVALID_OLD_PASSWORD"),
    USER_AUTHENTICATION_FAIL(10, "USER_AUTHENTICATION_FAIL"),
    USER_INVALID_PASSWORD_FORMAT(11, "USER_INVALID_PASSWORD_FORMAT");
