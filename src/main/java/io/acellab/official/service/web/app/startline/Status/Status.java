...
public enum Status {
    ...
    DATA_FOUND(7, "DATA_FOUND"),

    //Error Handling & Test Message
    UNEXPECTED_ERROR (8, "UNEXPECTED_ERROR"),
    TESTING(9, "TESTING_MESSAGE"),

    //User Status
    USER_INVALID_OLD_PASSWORD(10, "USER_INVALID_OLD_PASSWORD"),
    USER_AUTHENTICATION_FAIL(11, "USER_AUTHENTICATION_FAIL"),
    USER_INVALID_PASSWORD_FORMAT(12, "USER_INVALID_PASSWORD_FORMAT");
