document.getElementById('updatestartupinfo').addEventListener('submit', function(event) {
	//Prevent default form submission
	event.preventDefault();

	let dataMap = new Map();
	dataMap.set("Name", document.getElementById("startup_name").value);
	dataMap.set("Introduction", document.getElementById("startup_introduction").value);
	dataMap.set("Email", document.getElementById("startup_email").value);
	dataMap.set("Phone", document.getElementById("startup_areacode").value + '-' + document.getElementById("startup_phone").value);
	dataMap.set("Website", document.getElementById("startup_website").value);
	dataMap.set("Size", document.getElementById("startup_size").value);
	dataMap.set("Year", document.getElementById("startup_foundedyear").value);
	dataMap.set("Industry", document.getElementById("startup_industry").value);
	dataMap.set("Headquarter", document.getElementById("startup_headquarter").value);
...
addInputValidation("startup_name", /^[\p{L}\s]*$/u);
addInputValidation("startup_phone", /^\d*$/);
addInputValidation("startup_size", /^[\d-]+$/);
