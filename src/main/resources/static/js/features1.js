...
document.getElementById("addSectionBtn").addEventListener("click", function () {
  ...
  newFinanceRound.innerHTML = `
    ...
    <article class="flex_left_space">
      ...
      <img th:src="@{../images/icon/Trash.png}" class="DeleteRow" alt="Delete Round" />
    </article>
  `;
...
document.getElementById("AddProductBtn").addEventListener("click", function () {
  ...
  newProductRound.innerHTML = `
      ...
      <article class="flex_left_space">
        ...
        <img th:src="@{../images/icon/Trash.png}" class="DeleteRow" alt="Delete Product" />
      </article>
    `;
...
document.getElementById("addTeamBtn").addEventListener("click", function () {
  ...
  newTeamMember.innerHTML = `
          ...
          <select id="areaCode" name="areaCode" class="filters">
          ...
          <input type="text" id="phone" name="phone" placeholder="1234-5678" class="filters5" required />
                    <br />
                ...
                <img th:src="@{../images/icon/Trash.png}" class="DeleteRow" alt="Delete Member" />
                </article>
            `;
